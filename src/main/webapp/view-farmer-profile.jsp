...
<%
	if(request.getParameter("submit")!=null){
		...
		ps.setInt(6, id);
		ps.executeUpdate();
		out.print("<script type='text/javascript'>alert('Farmer updated successfully');location.href = 'farmer-dashboard.jsp';</script>");		
	}

	ResultSet rs = con.createStatement().executeQuery("select * from farmer where f_id="+session.getAttribute("uid"));
	rs.next();
%>
